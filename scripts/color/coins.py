...
def main():
    ...
    for color in c.fg:
        ...
        print_box(10, 4, 10, 11, x_off, 0, c.fg[0], '█')
        print_box(7, 10, 10, 10, x_off, 0, c.fg[0], '█')

        print_box(7, 2, 10, 2, x_off, 0, c.fg[7], '█')
        print_box(5, 3, 7, 3, x_off, 0, c.fg[7], '█')
        print_box(4, 4, 5, 4, x_off, 0, c.fg[7], '█')
        print_box(7, 4, 10, 4, x_off, 0, c.fg[7], '█')
        print_box(3, 5, 3, 9, x_off, 0, c.fg[7], '█')
        print_box(7, 4, 7, 10, x_off, 0, c.fg[7], '█')
        print_box(4, 9, 4, 11, x_off, 0, c.fg[7], '█')
        print_box(5, 11, 5, 11, x_off, 0, c.fg[7], '█')
